...
public class TemperatureV2BrickletHandler implements DeviceHandler {
  ...
  public TemperatureV2BrickletHandler(
      final MqttClient mqttClient, final BridgeProperties properties) {
              ...
              try {
                        ...
                        SensorConfig.builder()
                            ...
                            .device(
                                Device.builder()
                                    .name(temperatureSensor.getName())
                                    .identifiers(
                                        Collections.singletonList(temperatureSensor.getId()))
                                    .build())
                ...
                mqttClient.send(
                    properties.getDiscoveryPrefix()
                        + "/sensor/"
                        + MqttMessageUtil.strip(temperatureSensor.getId())
                        + "/config",
